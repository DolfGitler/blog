@if ($paginator->hasPages())
      <div class="join my-2 w-full justify-center ">
            ...
            @if ($paginator->onFirstPage())
                <button class="join.item btn btn-disabled" aria-hidden="true"aria-disabled="true" aria-label="@lang('pagination.previous')">&lsaquo;</button>
            @else
            ...
            @else
            <button class="join.item btn btn-disabled" aria-hidden="true"aria-disabled="true" aria-label="@lang('pagination.next')">&rsaquo;</button>
